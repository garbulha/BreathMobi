...
public class ApiUber extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DROPOFF_LAT = (float) getIntent().getDoubleExtra(Constantes.LATITUDE, 0);
        DROPOFF_LONG = (float) getIntent().getDoubleExtra(Constantes.LONGITUDE, 0);

        PICKUP_LAT = (float) getIntent().getDoubleExtra(Constantes.LATITUDE, 0);
        PICKUP_LONG = (float) getIntent().getDoubleExtra(Constantes.LONGITUDE, 0);
